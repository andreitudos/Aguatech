...
namespace Aguatech.Web.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Simbol")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Simbol")] Currency currency)
        {
            if (id != currency.Id)
            {
                return NotFound();
